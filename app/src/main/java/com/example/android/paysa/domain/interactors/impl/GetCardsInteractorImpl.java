 ...
 *
 */
public class GetCardsInteractorImpl extends AbstractInteractor implements GetCardsInteractor {

    private Callback mCallback;
    private Repository mRepository;

    public GetCardsInteractorImpl(Executor threadExecutor,
    ...
    public List<Card> createDummyCards() {
        List<Card> dummyCards = new ArrayList<Card>();

        Card a = new Card("Title 1",
        ...
        for(int i = 0; i < 10; i++){
            ...
            dummyCards.add(new Card(title, text, wage));
        }
    ...
    public void run() {
        ...
        mMainThread.post(new Runnable() {
            @Override
            public void run() {
                List<Card> cardsList = createDummyCards();
